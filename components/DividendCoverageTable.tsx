        ...
        <div className="flex items-start justify-between gap-3 flex-wrap">
          <div className="max-w-4xl">
            ...
            <p className="text-xs mt-2" style={{ color: "#8b8ba8" }}>
              ...
              unclear (hover the wider-case cell). Each quarter&apos;s PIK is shared out by that quarter&apos;s
              loan-level PIK rate × principal, with loans on non-accrual at zero — the PIK ledger&apos;s allocation,
              where an all-PIK floating loan quoted as a spread accrues at SOFR plus the spread — and the four
              quarters are added up.
            </p>
          </div>
